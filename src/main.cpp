...
void init_mpi(int *argc, char ***argv) {
  ...
  MPI_Type_create_struct(2, cluster_blocklengths, cluster_displacements,
    cluster_types, &mpi_cluster_t);
  MPI_Type_commit(&mpi_cluster_t);

  MPI_Op_create(&TranspositionTable::clusterOp, 1, &cluster_op);
}
